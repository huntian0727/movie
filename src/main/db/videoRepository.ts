...
import {
  countAllDuplicateGroups,
  getAssetCenterSummary,
  listAssetCenterSources
} from "../assetCenter/assetCenterQueries.js";
...
export class VideoRepository {
  ...
  getAssetCenterSummary(): AssetCenterSummary {
    return getAssetCenterSummary(this.db);
  }

  listAssetCenterSources(query: AssetCenterSourceQuery): AssetCenterSourcePage {
    return listAssetCenterSources(this.db, query);
  }
  ...
  private countAllDuplicateGroups(): number {
    return countAllDuplicateGroups(this.db);
  }
