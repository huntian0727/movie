...
const mainApi: VideoManagerApi = {
  ...
  batchRetryScanFailures: (failureIds: string[]) => ipcRenderer.invoke(channels.scanFailureReviewBatchRetry, { failureIds }),
  batchDeleteScanFailures: (failureIds: string[]) => ipcRenderer.invoke(channels.scanFailureReviewBatchDelete, { failureIds }),
